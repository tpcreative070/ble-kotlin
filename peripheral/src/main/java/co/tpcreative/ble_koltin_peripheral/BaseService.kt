...
internal open class BaseService(peripheralManager: BluetoothPeripheralManager, override val service: BluetoothGattService, override val serviceName: String) :
    Service {
