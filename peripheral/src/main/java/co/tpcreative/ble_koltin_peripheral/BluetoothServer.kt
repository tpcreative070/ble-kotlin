...
import co.tpcreative.ble.kotlin.core.AdvertiseError
import co.tpcreative.ble.kotlin.core.BluetoothCentral
import co.tpcreative.ble.kotlin.core.BluetoothPeripheralManager
import co.tpcreative.ble.kotlin.core.BluetoothPeripheralManagerCallback
...
class BluetoothServer(private val context: Context) {
    ...
    fun startAdvertising() {
        startAdvertising(HeartRateService.Companion.HRS_SERVICE_UUID)
    }
